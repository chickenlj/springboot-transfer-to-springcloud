...
public class XdsConfigProperties {
    ...
    public String getCaCert() {
      return "-----BEGIN CERTIFICATE-----\n"
              + "MIIDaTCCAlGgAwIBAgIRAMlGB/WXGFcaJALKawBlVwUwDQYJKoZIhvcNAQELBQAw\n"
              + "TjFMMEoGA1UEChNDZ292LTViOGU3ZmVhYmQ4MzQwNjE4MDRlNTM4NmVmNzg4Mzk3\n"
              + "Lmdvdi5uYWNvcy1hbnMubXNlLmFsaXl1bmNzLmNvbTAeFw0yNDA2MTQwOTQ4MzZa\n"
              + "Fw0zNDA2MTIwOTQ4MzZaME4xTDBKBgNVBAoTQ2dvdi01YjhlN2ZlYWJkODM0MDYx\n"
              + "ODA0ZTUzODZlZjc4ODM5Ny5nb3YubmFjb3MtYW5zLm1zZS5hbGl5dW5jcy5jb20w\n"
              + "ggEiMA0GCSqGSIb3DQEBAQUAA4IBDwAwggEKAoIBAQCyYgO+eQ7q+tJNK6FBwF/O\n"
              + "pV9yXFIIr631GJrrW85W6F0+4MgDMcWoZcahRROnYmousPzPakTC8W25NXxRb5nF\n"
              + "MgvkDru6G1zjH06jGWro+PVxwniubKnVdxTsZ3GyGlIG0A44ZrbIiPazw2RUN27H\n"
              + "mmb65js4bUKItsd/3p1tjCMtvM9qZujArKKm9WhzHvtd3pE9DFUf8ad2A09LNObT\n"
              + "7csdEx57Uw3GbD+RYQjRSMmwhaWSIBKU7s7uLYVfXU/83ES6NnW3gaAUtHvD/k56\n"
              + "0EQMR0VnIlE8DK4KYZU/rlQ0US6CVJOw7l5ZJuoCxHP+xaGh0pxoVpsUYn4xeF5V\n"
              + "AgMBAAGjQjBAMA4GA1UdDwEB/wQEAwICBDAPBgNVHRMBAf8EBTADAQH/MB0GA1Ud\n"
              + "DgQWBBRNDXU/o5KmW5j+3rtUM9Vhhxg09zANBgkqhkiG9w0BAQsFAAOCAQEANAmA\n"
              + "7MhCZfTN6w3IAnyvPynk9RbCF+4nUQ6EeQtAp/IVrd8D6PWIxZ5HM7WTZQw0kA9x\n"
              + "92oNxI7ESh2CmI2bmAAYs6s/yLQykpN3fn9g8KDxILxGTfppbBAgH6jSccgcR1fw\n"
              + "w49gNcMimTrn4l+2xG8qJ9Ysldl0r899xTlsfnklWrXVyj495cFLFR/UqcKHMrF8\n"
              + "hMQa4SPkrKQu76fC13O14qszv2l/B67fveTZ3PE9WN3xfihzZfM8qfrpfiDtoYDy\n"
              + "OG6m2JN01fYDkXIuRHpLp+jSu/rcLQUEVhxXqBEniH1Sa1MFHm3TlGRFNEo0scpw\n"
              + "J7Gw2usleOAy98zqxQ==\n"
              + "-----END CERTIFICATE-----";
