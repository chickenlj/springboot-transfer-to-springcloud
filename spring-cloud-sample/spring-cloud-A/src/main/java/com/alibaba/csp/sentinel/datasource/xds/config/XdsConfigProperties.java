...
public class XdsConfigProperties {
    ...
    public String getCaCert() {
      return "-----BEGIN CERTIFICATE-----\n"
              + "MIIDaDCCAlCgAwIBAgIQHFZXesUfBEGNQntrpvTu2jANBgkqhkiG9w0BAQsFADBO\n"
              + "MUwwSgYDVQQKE0Nnb3YtNWI4ZTdmZWFiZDgzNDA2MTgwNGU1Mzg2ZWY3ODgzOTcu\n"
              + "Z292Lm5hY29zLWFucy5tc2UuYWxpeXVuY3MuY29tMB4XDTI0MDYxNDA4NDYwMloX\n"
              + "DTM0MDYxMjA4NDYwMlowTjFMMEoGA1UEChNDZ292LTViOGU3ZmVhYmQ4MzQwNjE4\n"
              + "MDRlNTM4NmVmNzg4Mzk3Lmdvdi5uYWNvcy1hbnMubXNlLmFsaXl1bmNzLmNvbTCC\n"
              + "ASIwDQYJKoZIhvcNAQEBBQADggEPADCCAQoCggEBAJu8womKoXIR1TbQKSOX+pj2\n"
              + "GLvRg6DDNsUbKXAwkFwvtoT3yrEtqkOL6nuwMbtRyS/vtHVOYii53Y/jXNIuiyOL\n"
              + "vK6G5Hz6HCReOM/XISJuSQw6mqCDblk20jrg8pFhLY9NNjO9zDsf38QZQABrq+bi\n"
              + "8XRHaqUk3oqIrfpXFVvuk9Tf30BTfX0oL2jioQU4n+ZgbscUBquTPeiitF3Yabob\n"
              + "AbHvOyz/CliCz2S7xhdkfwnL8N64erZBPCoq3WpVbCqpuUh7HwJnLaMhHB6/z/D2\n"
              + "Vt0hi1oUK5pQx8z/I6/Jd6J/EiBWx7g/V6zm2svL2bSXO1fqBLw8PAKcfLmcX+UC\n"
              + "AwEAAaNCMEAwDgYDVR0PAQH/BAQDAgIEMA8GA1UdEwEB/wQFMAMBAf8wHQYDVR0O\n"
              + "BBYEFPb/WYfYBeGd5+ApK2cQ09iY2l52MA0GCSqGSIb3DQEBCwUAA4IBAQAKcbA9\n"
              + "vkA8kPMvKyEIH1C7iLjMHMyiQAILskGPn1RXCbCaMr9Bqohsp/bCz23yXbP4vG6P\n"
              + "yG5jZqjGAxr6s2lYqhei/YzEtngtLgClsC20rqoczh9WTEK+e6670CdVvTJha06J\n"
              + "QkAGazrKmtvHtpgubmPRtNqYgUJLVD3iONhHue+EykreNxmhvfZH94Xxfd8ZFw5x\n"
              + "ygKMwbgdKybqt3mbpAzyYXCDtD1dZBhGFDg2czScWWsd6eY0Ks6jNQPMkVggLCCx\n"
              + "YOW0oVoLLGUZljqyKGyQKBY0uNMku4UeQveGOXMtwHD9Fc+E0zlYW2sTtQe5L33O\n"
              + "vqSPPRVKsj4QWwDZ\n"
              + "-----END CERTIFICATE-----";
