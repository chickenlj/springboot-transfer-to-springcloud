...
public class XdsConfigProperties {
    ...
    public String getCaCert() {
      return "-----BEGIN CERTIFICATE-----\n"
              + "MIIDaTCCAlGgAwIBAgIRALakwSfGmN502nux3SiQEMUwDQYJKoZIhvcNAQELBQAw\n"
              + "TjFMMEoGA1UEChNDZ292LTViOGU3ZmVhYmQ4MzQwNjE4MDRlNTM4NmVmNzg4Mzk3\n"
              + "Lmdvdi5uYWNvcy1hbnMubXNlLmFsaXl1bmNzLmNvbTAeFw0yNDA2MTMxMTIxNTBa\n"
              + "Fw0zNDA2MTExMTIxNTBaME4xTDBKBgNVBAoTQ2dvdi01YjhlN2ZlYWJkODM0MDYx\n"
              + "ODA0ZTUzODZlZjc4ODM5Ny5nb3YubmFjb3MtYW5zLm1zZS5hbGl5dW5jcy5jb20w\n"
              + "ggEiMA0GCSqGSIb3DQEBAQUAA4IBDwAwggEKAoIBAQDF2QRtIex0k1ztmUcGrvuZ\n"
              + "rvmRcXF3clK0WbPztcB7vOqoKIYOuthbWCXmiKVCu7zrPP5N/GLpOJHb3z5J3fyv\n"
              + "FxIXXJ7U8LneiDA/Aft2DYzoEK/cdBr3qGBy+5JkZlJEytYx1ZndLAo+g17iqZV9\n"
              + "SGo2aIonRP/eCTUNTukyUXzDbQj1EuWl5Uja2FzQArve6h0ox/HvZ3vGZrk0RpBF\n"
              + "wzljp6VhRA76g2vSEd4sbYvFZ6BmvwwO8U2ocPYL5A7kgatWJJLMjTeQmj4H3R//\n"
              + "Juoxrlhlj9kciXUTsAh3B5DhtUTRuAX4zTq00XtUXiqku9UerfP7np0AdzmkpSqZ\n"
              + "AgMBAAGjQjBAMA4GA1UdDwEB/wQEAwICBDAPBgNVHRMBAf8EBTADAQH/MB0GA1Ud\n"
              + "DgQWBBQCYar9zh+wP8PzFI1zsYBT/HLHjzANBgkqhkiG9w0BAQsFAAOCAQEAc+3h\n"
              + "oGydYJ9wkYCy6Jww2AVi3ZK5X+KfFbqhgKydPo9gGjvxI0K725p84swwZbCVhQoG\n"
              + "rfVvcz669OIDHrpI9Yu0NPOgVS9ARGVJGuQOWfD3q88kOVbC0M1nF/9yErzZDdym\n"
              + "K17hcY0Z3Nr3PWgXkTaM8ndly8z0xBlXR/OWX3kHDVtTQABPjAchKDB/HBkHpgOr\n"
              + "VN1rFdGPAkglel0PyFIuF5gk8YuKy0hpd/EtNC/QWv+n1I8Abo3xGvUJBSEmQyNA\n"
              + "zeh+o37GNHtg4t1kt6EuD6yTpW/XBkjLrbipb2YHlTR7LjGY4cGqKO/ZEtGXgQCn\n"
              + "5pdbftXIrSKKYfSy0A==\n"
              + "-----END CERTIFICATE-----";
